...
export default function Cutlery() {
    return (
      ...
      >
        <div className="max-w-5xl mx-auto text-center bg-white bg-opacity-80 p-6 sm:p-8 md:p-10 rounded-md">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-6 text-gray-700">
          ...
          <div className="mt-8 sm:mt-12 w-full flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-0">
            <div className="flex-grow w-full sm:w-auto">
              ...
              <input
                ...
                className="w-full h-16 sm:h-10 bg-gray-50 py-2 px-4 text-gray-800 focus:outline-none focus:ring focus:ring-indigo-500 rounded-md sm:rounded-none sm:rounded-l-md"
              />
            </div>
            <button
              type="submit"
